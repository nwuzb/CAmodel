...
# ================ 配置参数（可修改） ================
# 输入文件路径
VIDEO_PATH = "/Users/binzeng/MA/GT_videos/gt_30_2_clip_03_right_124/2_clip_03_rightpart_124.mp4"  # 视频文件路径
GT_PATH = "/Users/binzeng/MA/GT_videos/gt_30_2_clip_03_right_124/gt.txt"         # 真值标注文件路径
OUTPUT_DIR = "/Users/binzeng/MA/GT_videos/gt_30_2_clip_03_right_124-results142"  # ❗️❗️❗️❗️结果保存目录，每次运行要使用空文件夹，否则会使用源文件，会变大
...
TRACKING_PARAMS = { 
    ...
    'min_detection_height': 18,    # 最小检测框高度 💊 20不错
    ...
    'std_weight_velocity': 1.0 / 40,    # 速度过程噪声权重 (增大，适应高速度变化) 💊
    'std_weight_acceleration': 1.0 / 100, # 加速度过程噪声权重 (增大，适应高加速度)💊
